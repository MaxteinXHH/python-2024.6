...
butt1 =tk.Button(root, text="获取并保存数据",cursor='hand2', command=cse1).place(x=15,y=100)
labb1=tk.Label(root,text="控 制 台").place(x=35,y=65)
batt2=tk.Button(root,text="处理并保存数据",cursor='hand2',command=cse2).place(x=15,y=170)
labb2=tk.Label(root,text="福布斯全球富豪榜实时数据分析系统",font=('黑体',22),fg='blue').place(x=49,y=20)

butt3 =tk.Button(root, text="关于",cursor='hand2', command=cse7).place(x=15,y=450)
